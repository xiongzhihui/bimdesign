========================================================================
    ZWCAD+ 二次开发程序 : BimDesign 项目概述
========================================================================


应用程序向导已为您创建了此 BimDesign DLL。  
本文件概要介绍组成 BimDesign zrx 的每个文件的内容。
...
BimDesign_z14.vcxproj
	zrx 2014 项目文件

BimDesign_z14.vcxproj.filters
